                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    <DropdownMenuItem onClick={() => handleHighlight(tx.id, 'yellow', tx.highlight)}>
                                        <div className="w-4 h-4 rounded-full bg-yellow-400 mr-2"></div> Highlight 1
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => handleHighlight(tx.id, 'blue', tx.highlight)}>
                                        <div className="w-4 h-4 rounded-full bg-blue-400 mr-2"></div> Highlight 2
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => handleHighlight(tx.id, 'green', tx.highlight)}>
                                        <div className="w-4 h-4 rounded-full bg-green-400 mr-2"></div> Highlight 3
                                    </DropdownMenuItem>
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                <AlertDialogAction onClick={() => handleDelete(tx.id)} disabled={isPending}>Delete</AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </DropdownMenuContent>
